...
QUnit.test('can log and retrieve messages', function(assert) {
    const trace = { level: 'trace', msg: 'trace' };
    const debug = { level: 'debug', msg: 'debug' };
    const info = { level: 'info', msg: 'info' };
    const warn = { level: 'warn', msg: 'warn' };
    const error = { level: 'error', msg: 'error' };
    const fatal = { level: 'fatal', msg: 'fatal' };
    let messages;
